...
CUDA_VISIBLE_DEVICES=0,1 torchrun --nproc_per_node=2 --master_port=29504 scripts/train_sam3_refship.py \
  --refer-data-root /root/nas/rrsisd \
  --batch-size 2 \
  --epochs 40 \
  --lr 1e-4 \
  --img-size 1008 \
  --experiment-name sam3_rrsisd_40e_1008 \
  --output-dir /root/nas/rrsisd/logs/sam3_40e_1008 \
  --swanlab
  --use-lora \
  --lora-r 32 \
  --lora-alpha 64.0 \
