...
def get_parser():
    ...
    parser.add_argument(
        "--bert_tokenizer",
        default="/root/nas/refship/bert-base-uncased",
        help="BERT tokenizer",
    )
    parser.add_argument(
        "--ck_bert",
    ...
    parser.add_argument(
        "--dataset", default="refship", help="refcoco, refcoco+, or refcocog"
    )
    parser.add_argument(
        "--ddp_trained_weights",
        action="store_true",
    ...
    parser.add_argument(
        "--lr", default=0.00005, type=float, help="the initial learning rate"
    )
    parser.add_argument(
        "--mha",
        default="",
    ...
    parser.add_argument("--model_id", default="rrsis_embedding", help="name to identify the model")
    parser.add_argument(
        "--output-dir", default="/root/nas/rrsisd/logs/rrsis/", help="path where to save checkpoint weights"
    )
    parser.add_argument(
        "--pin_mem",
        action="store_true",
    ...
    parser.add_argument(
        ...
        default="/root/nas/refship/swin_base_patch4_window12_384_22k.pth",
        help="path to pre-trained Swin backbone weights",
    )
    parser.add_argument("--print-freq", default=50, type=int, help="print frequency")
    parser.add_argument(
        "--refer_data_root",
        default="/root/nas/refship/",
    ...
    parser.add_argument(
        ...
        action='store_true',
        default=False,
        help='If set, use BERT encoder for text features; otherwise, only use embedding.'
    )
    return parser
